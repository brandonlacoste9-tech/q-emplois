...
const T = {
  fr: {
    ...
    wa: {
      title: "Alertes Telegram pour travailleurs",
    ...
    pro: {
      ...
      perks: [
        "Recevez des offres directement sur Telegram",
  ...
  en: {
    ...
    wa: {
      title: "Telegram alerts for taskers",
    ...
    pro: {
      ...
      perks: [
        "Get job offers directly on Telegram",
