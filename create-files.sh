#!/bin/bash
mkdir -p frontend/src/context frontend/src/components frontend/src/styles

cat > frontend/src/context/LanguageContext.tsx << 'EOF'
...
echo "Created LanguageContext.tsx"
